...
class CalendarCarousel<T extends EventInterface> extends StatefulWidget {
  ...
  final LinearGradient selectedDayGradient;
  ...
  CalendarCarousel({
    ...
    this.selectedDayGradient = const LinearGradient(
  ...
  Widget renderDay(
    ...
    return Container(
      ...
      child: GestureDetector(
        ...
        child: FlatButton(
          color: isSelectedDay && widget.selectedDayGradient != null
              ? Colors.transparent
          ...
          child: Container(
            decoration: isSelectedDay ? BoxDecoration(
                ...
                gradient: widget.selectedDayGradient) : null,
            child: Stack(
